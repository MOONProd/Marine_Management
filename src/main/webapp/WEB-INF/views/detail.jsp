...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/detail_styles.css">
...
<body>
    ...
    <div class="profile-card">
        ...
        <p><i class="fas fa-calendar-alt"></i><strong> 입사 날짜:</strong> ${admissionDateStr}<br>(함께한 지 D+${marine.daysSinceAdmission})</p>
